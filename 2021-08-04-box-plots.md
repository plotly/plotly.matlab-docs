...
plotly(data);
```
{% capture plot_683715572408 %}{% raw %}{"data": [{"y": [0, 1, 1, 2, 3, 5, 8, 13, 21], "boxpoints": "all", "jitter": 0.3, "pointpos": -1.8, "type": "box"}], "layout": {"width": 840, "height": 630}, "frames": []}{% endraw %}{% endcapture %}{% include posts/ssim_frame.html raw_json_file=plot_683715572408 index=683715572408 %}
