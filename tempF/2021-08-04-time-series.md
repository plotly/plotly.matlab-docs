...
{% endcapture %}
{% include posts/ssim_frame.html raw_json_file=plot_625937626080 index=625937626080 %}
...
fig2plotly(gcf);
```
{% capture plot_137868992413 %}
{% raw %}{"data": [], "layout": {"autosize": false, "margin": {"pad": 0, "l": 0, "r": 0, "b": 0, "t": 0}, "showlegend": false, "width": 840, "height": 630, "paper_bgcolor": "rgb(255,255,255)", "hovermode": "closest", "annotations": [{"showarrow": false, "xref": "paper", "yref": "paper"}]}, "frames": []}{% endraw %}
{% endcapture %}
{% include posts/ssim_frame.html raw_json_file=plot_137868992413 index=137868992413 %}
...
fig2plotly(gcf);
```
{% capture plot_217801593712 %}
{% raw %}{"data": [], "layout": {"autosize": false, "margin": {"pad": 0, "l": 0, "r": 0, "b": 0, "t": 0}, "showlegend": false, "width": 840, "height": 630, "paper_bgcolor": "rgb(255,255,255)", "hovermode": "closest", "annotations": [{"showarrow": false, "xref": "paper", "yref": "paper"}]}, "frames": []}{% endraw %}
{% endcapture %}
{% include posts/ssim_frame.html raw_json_file=plot_217801593712 index=217801593712 %}
...
{% raw %}{"data": [], "layout": {"autosize": false, "margin": {"pad": 0, "l": 0, "r": 0, "b": 0, "t": 0}, "showlegend": false, "width": 840, "height": 630, "paper_bgcolor": "rgb(255,255,255)", "hovermode": "closest", "annotations": [{"showarrow": false, "xref": "paper", "yref": "paper"}]}, "frames": []}{% endraw %}
{% endcapture %}
{% include posts/ssim_frame.html raw_json_file=plot_182141075890 index=182141075890 %}
...
Y =
    ...
    52    35    31
```
{% capture plot_726104431665 %}
{% raw %}{"data": [], "layout": {"autosize": false, "margin": {"pad": 0, "l": 0, "r": 0, "b": 0, "t": 0}, "showlegend": false, "width": 840, "height": 630, "paper_bgcolor": "rgb(255,255,255)", "hovermode": "closest", "annotations": [{"showarrow": false, "xref": "paper", "yref": "paper"}]}, "frames": []}{% endraw %}
{% endcapture %}
{% include posts/ssim_frame.html raw_json_file=plot_726104431665 index=726104431665 %}
...
{% endcapture %}
{% include posts/ssim_frame.html raw_json_file=plot_782872072979 index=782872072979 %}
...
```
{% capture plot_693787614987 %}
{% raw %}{"data": [], "layout": {"autosize": false, "margin": {"pad": 0, "l": 0, "r": 0, "b": 0, "t": 0}, "showlegend": false, "width": 840, "height": 630, "paper_bgcolor": "rgb(255,255,255)", "hovermode": "closest", "annotations": [{"showarrow": false, "xref": "paper", "yref": "paper"}]}, "frames": []}{% endraw %}
{% endcapture %}
{% include posts/ssim_frame.html raw_json_file=plot_693787614987 index=693787614987 %}
...
s = 
  ...
  Show <a href="matlab:if exist('s', 'var'), matlab.graphics.internal.getForDisplay('s', s, 'matlab.graphics.chart.StackedLineChart'), else, matlab.graphics.internal.getForDisplay('s'), end">all properties</a>
```
{% capture plot_9802252263 %}
{% raw %}{"data": [], "layout": {"autosize": false, "margin": {"pad": 0, "l": 0, "r": 0, "b": 0, "t": 0}, "showlegend": false, "width": 840, "height": 630, "paper_bgcolor": "rgb(255,255,255)", "hovermode": "closest", "annotations": [{"showarrow": false, "xref": "paper", "yref": "paper"}]}, "frames": []}{% endraw %}
{% endcapture %}
{% include posts/ssim_frame.html raw_json_file=plot_9802252263 index=9802252263 %}
...
ans = 
  ...
  3×1 <a href="matlab:helpPopup matlab.graphics.chart.internal.stackedplot.StackedLineProperties" style="font-weight:bold">StackedLineProperties</a> array with properties:
    ...
    PlotType
```
{% capture plot_843213338011 %}
{% raw %}{"data": [], "layout": {"autosize": false, "margin": {"pad": 0, "l": 0, "r": 0, "b": 0, "t": 0}, "showlegend": false, "width": 840, "height": 630, "paper_bgcolor": "rgb(255,255,255)", "hovermode": "closest", "annotations": [{"showarrow": false, "xref": "paper", "yref": "paper"}]}, "frames": []}{% endraw %}
{% endcapture %}
{% include posts/ssim_frame.html raw_json_file=plot_843213338011 index=843213338011 %}
...
ans = 
  ...
  3×1 <a href="matlab:helpPopup matlab.graphics.chart.internal.stackedplot.StackedLineProperties" style="font-weight:bold">StackedLineProperties</a> array with properties:
    ...
    PlotType
```
{% capture plot_922331997796 %}
{% raw %}{"data": [], "layout": {"autosize": false, "margin": {"pad": 0, "l": 0, "r": 0, "b": 0, "t": 0}, "showlegend": false, "width": 840, "height": 630, "paper_bgcolor": "rgb(255,255,255)", "hovermode": "closest", "annotations": [{"showarrow": false, "xref": "paper", "yref": "paper"}]}, "frames": []}{% endraw %}
{% endcapture %}
{% include posts/ssim_frame.html raw_json_file=plot_922331997796 index=922331997796 %}
...
plotly(data);
```
{% capture plot_770954220674 %}
{% raw %}{"data": [{"x": ["2013-10-04 22:23:00", "2013-11-04 22:23:00", "2013-12-04 22:23:00"], "y": [1, 3, 6], "type": "scatter"}], "layout": {"width": 840, "height": 630}, "frames": []}{% endraw %}
{% endcapture %}
{% include posts/ssim_frame.html raw_json_file=plot_770954220674 index=770954220674 %}
